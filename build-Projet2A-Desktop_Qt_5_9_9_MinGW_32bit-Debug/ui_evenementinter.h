...
public:
    ...
    void setupUi(QDialog *EvenementInter)
    {
        ...
        EvenementInter->resize(834, 615);
        tabWidget = new QTabWidget(EvenementInter);
        tabWidget->setObjectName(QStringLiteral("tabWidget"));
        tabWidget->setGeometry(QRect(30, 40, 781, 571));
        tab = new QWidget();
        ...
        groupBox_3->setGeometry(QRect(190, 100, 331, 201));
        ...
        groupBox_2->setGeometry(QRect(160, 110, 381, 201));
        ...
        tablemodifier->setGeometry(QRect(10, 160, 741, 251));
        tablemodifier->setAutoFillBackground(false);
        PDF = new QPushButton(tab_2);
        PDF->setObjectName(QStringLiteral("PDF"));
        PDF->setGeometry(QRect(570, 430, 131, 28));
    ...
    void retranslateUi(QDialog *EvenementInter)
    {
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QApplication::translate("EvenementInter", "Modifier Evenement", Q_NULLPTR));
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("EvenementInter", "Supprimer Evenement", Q_NULLPTR));
        PDF->setText(QApplication::translate("EvenementInter", "IPRIMER PDF", Q_NULLPTR));
