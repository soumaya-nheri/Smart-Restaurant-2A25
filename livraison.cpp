...
void livraison::on_pb_livreur_clicked()
{
...
void livraison::on_pb_ajouter_livreur_clicked()
{
...
void livraison::on_pb_modifer_livreur_clicked()
{
...
void livraison::on_pb_supp_livreur_clicked()
{int id;
    Livreur _l_l;
...
void livraison::on_le_search_livreur_textChanged(const QString &arg1)
{
    ui->tv_livreur->setModel(l.search(arg1));
}

void livraison::on_cb_sort_livreur_currentTextChanged(const QString &arg1)
{
    ui->tv_livreur->setModel(l.sort(arg1));
}

void livraison::on_pb_liv_ajout_clicked()
{
...
void livraison::on_pb_liv_modif_clicked()
{
...
void livraison::on_pb_supp_liv_clicked()
{
    Liv ___l;
...
void livraison::on_le_search_liv_textChanged(const QString &arg1)
{
    ui->tv_liv->setModel(L.search(arg1));
}

void livraison::on_cb_sort_liv_currentTextChanged(const QString &arg1)
{
