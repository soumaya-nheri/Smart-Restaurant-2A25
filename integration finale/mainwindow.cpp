...
void MainWindow::on_BAmenu_13_clicked()
{
...
void MainWindow::on_P_supprimer_7_clicked()
{
    Commande C1;
...
void MainWindow::on_tab_menu_5_activated(const QModelIndex &index)
{
...
void MainWindow::on_BAmenu_14_clicked()
{
    ui->stackedWidget->setCurrentWidget(ui->page_2);

}

void MainWindow::on_BAmenu_15_clicked()
{
    ui->stackedWidget->setCurrentWidget(ui->page);
}

void MainWindow::on_cherchermenu_5_clicked()
{
...
void MainWindow::on_trimenu_11_clicked()
{
     ui->tab_menu_5->setModel(C.triercommande());
}

void MainWindow::on_trimenu_12_clicked()
{
