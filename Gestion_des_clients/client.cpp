...
QSqlQueryModel* Client::chercher_client_par_nom( QString nom)
 {

    {QSqlQueryModel *model = new QSqlQueryModel;
        model->setQuery("SELECT * FROM Menu WHERE nom =:nom ");
        model->setHeaderData(0, Qt::Horizontal, QObject::tr("id"));
        model->setHeaderData(1, Qt::Horizontal, QObject::tr(" nom client"));
          model->setHeaderData(1, Qt::Horizontal, QObject::tr(" prenom client"));
          model->setHeaderData(1, Qt::Horizontal, QObject::tr("adresse "));
               model->setHeaderData(1, Qt::Horizontal, QObject::tr("nmero tel client"));;
        return model;
    }
...
QSqlQueryModel* Client::chercher_client_par_id(int id)
 {
    ...
    {QSqlQueryModel *model = new QSqlQueryModel;
        ...
        model->setHeaderData(1, Qt::Horizontal, QObject::tr(" nom client"));
          model->setHeaderData(1, Qt::Horizontal, QObject::tr(" prenom client"));
          model->setHeaderData(1, Qt::Horizontal, QObject::tr("adresse "));
               model->setHeaderData(1, Qt::Horizontal, QObject::tr("numero tel client"));;
        return model;
    }

 }
QSqlQueryModel* Client::chercher_client_par_prenom(QString)
 {

    {QSqlQueryModel *model = new QSqlQueryModel;
        model->setQuery("SELECT * FROM menu WHERE prenom=:prenom  ");
        model->setHeaderData(0, Qt::Horizontal, QObject::tr("id"));
        model->setHeaderData(1, Qt::Horizontal, QObject::tr(" nom client"));
          model->setHeaderData(1, Qt::Horizontal, QObject::tr(" prenom client"));
