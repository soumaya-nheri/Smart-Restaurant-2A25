...
void gestion_produit::on_BA_clicked()
{
...
void gestion_produit::on_b_supprimer_currentChanged(int index)
{
...
void gestion_produit::on_tabfournisseur_currentChanged(int index)
{
    ui->tab_fournisseur->setModel(F.afficherfourniseeur());
...
void gestion_produit::on_P_supprimer_clicked()
{
    Ingredient I1;
...
void gestion_produit::on_comboBox_currentTextChanged(const QString &arg1)
{
...
void gestion_produit::on_tri_emp_2_clicked()
{
...
void gestion_produit::on_tri_emp_3_clicked()
{
    ui->tab_ingredient->setModel(I.trier());
}

void gestion_produit::on_tri_emp_4_clicked()
{
    ui->tab_ingredient->setModel(I.trier2());
}

void gestion_produit::on_chercher_clicked()
{
...
void gestion_produit::on_pdf_clicked()
{
...
void gestion_produit::on_qr_clicked()
{
...
/*void gestion_produit::on_ajoutfournisseur_clicked()
{
...
/*void gestion_produit::on_comboBox2_activated(int index)
{

}
*/
void gestion_produit::on_P_supprimer_2_clicked()
{
    Fournisseur F1;
...
/*void gestion_produit::on_tri_emp_5_clicked()
{
     ui->tab_fournisseur->setModel(F.trierfournisseur());
}

void gestion_produit::on_chercher_2_clicked()
{
...
*/
void gestion_produit::on_modiffour_clicked()
{
...
void gestion_produit::on_comboc1_currentTextChanged(const QString &arg1)
{
...
void gestion_produit::on_chercherfour_clicked()
{
...
void gestion_produit::on_trifour_clicked()
{
     ui->tab_fournisseur->setModel(F.triernom());
}

void gestion_produit::on_trifour_2_clicked()
{
    ui->tab_fournisseur->setModel(F.trierprenom());
}

void gestion_produit::on_trifour_3_clicked()
{
    ui->tab_fournisseur->setModel(F.trieremail());
}

void gestion_produit::on_pdffour_clicked()
{
...
/*voidgestion_produit::on_pushButton_clicked()
{
     ui->stackedWidget->setCurrentIndex(3);
}

voidgestion_produit::on_pushButton_2_clicked()
{
      ui->stackedWidget->setCurrentIndex(2);
}
*/
void gestion_produit::on_BAmenu_clicked()
{
...
void gestion_produit::on_P_supprimer_3_clicked()
{
...
void gestion_produit::on_modifmenub_clicked()
{
...
void gestion_produit::on_tab_menu_clicked(const QModelIndex &index)
{
...
void gestion_produit::on_trimenu_clicked()
{
    ui->tab_menu->setModel(M.triermenu());
}

void gestion_produit::on_trimenu_2_clicked()
{
    ui->tab_menu->setModel(M.triermenu2());
}

void gestion_produit::on_cherchermenu_clicked()
{
...
void gestion_produit::on_gestion4_clicked()
{
     ui->stackedWidget->setCurrentIndex(1);
}

void gestion_produit::on_gestion1_clicked()
{
     ui->stackedWidget->setCurrentIndex(0);
}

void gestion_produit::on_gestion5_clicked()
{
     ui->stackedWidget->setCurrentIndex(2);
}
void gestion_produit::on_gestion2_clicked()
{
     ui->stackedWidget->setCurrentIndex(3);
}


void gestion_produit::on_lineEdit_2_textChanged(const QString &arg1)
{
     ui->tab_ingredient->setModel(I.search(arg1));
}

void gestion_produit::on_pdf_2_clicked()
{
    QTableView tab_menu;
    QSqlQueryModel * Modal=new  QSqlQueryModel();
...
void gestion_produit::on_lineEdit_5_textChanged(const QString &arg1)
{
...
void gestion_produit::digit_pressed()
{
...
void gestion_produit::on_pushButton_dot_released()
{
...
void gestion_produit::unary_operation_pressed()
{
    QPushButton* button = (QPushButton *)sender();
    double labelnumber;
    QString input;
...
void gestion_produit::on_pushButton_clear_released()
{
...
void gestion_produit::on_pushButton_equals_released()
{
...
void gestion_produit::binary_operation_pressed()
{
    QPushButton* button = (QPushButton *)sender();
    //double labelnumber;
    //QString input;
...
void gestion_produit::on_btnmodif_clicked()
{
    Ingredient e(ui->modif1->text().toInt(),ui->modif2->text(),ui->modif3->text().toInt(),ui->modif4->date(),ui->modif5->text());
        bool test=e.modifier(ui->comboBox->currentText().toInt());
        if(test){
...
void gestion_produit::on_muteSound_clicked()
{
   sound->stop();
}
void gestion_produit::on_actionSound_clicked()
...
void gestion_produit::on_ouvrir_media_clicked()
{
...
void gestion_produit::on_play_media_clicked()
{
    mMediaPlayer->play();
}

void gestion_produit::on_pause_media_clicked()
{
    mMediaPlayer->pause();
}

void gestion_produit::on_stop_media_clicked()
{
    mMediaPlayer->stop();
}

void gestion_produit::on_mute_media_clicked()
{
...
void gestion_produit::on_volume_media_valueChanged(int value)
{
...
void gestion_produit::on_newfile_clicked()
{
...
void gestion_produit::on_copier_clicked()
{
      ui->textEdit->copy();
}

void gestion_produit::on_coller_clicked()
{
    ui->textEdit->paste();
}

void gestion_produit::on_couper_clicked()
{
    ui->textEdit->cut();

}

void gestion_produit::on_redo_clicked()
{ ui->textEdit->redo();

}

void gestion_produit::on_undo_clicked()
{
     ui->textEdit->undo();
}

void gestion_produit::on_savefile_clicked()
{
...
void gestion_produit::on_openfile_clicked()
{
...
void gestion_produit::on_clear_clicked()
{
    currentFile.clear();
...
void gestion_produit::on_imprimer_clicked()
{
    QPrinter printer;
...
void gestion_produit::on_logout_button_clicked()
{
