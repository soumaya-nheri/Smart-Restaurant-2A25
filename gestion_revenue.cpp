...
#include<QDate>
#include <notif.h>
gestion_revenue::gestion_revenue(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::gestion_revenue)
{
    ui->setupUi(this);
    ui->lineEdit_iddepense->setValidator(new QIntValidator(0, 9999999, this));
        ui->tab_depense->setModel(D.afficher());
        ui->tab_revenue->setModel(R.afficher());
}

gestion_revenue::~gestion_revenue()
{
    delete ui;
}
void gestion_revenue::on_BA_clicked()
{
...
void gestion_revenue::on_b_supprimer_currentChanged(int index)
{
...
void gestion_revenue::on_P_supprimer_clicked()
{
  depense D1;
...
void gestion_revenue::on_comboBox_currentTextChanged(const QString &arg1)
{
...
void gestion_revenue::on_pushButton_5_clicked()
{
...
void gestion_revenue::on_tri_emp_2_clicked()
{
        ui->tab_depense->setModel(D.trier1());
}



void gestion_revenue::on_tri_emp_3_clicked()
{
    ui->tab_depense->setModel(D.trier());
}

void gestion_revenue::on_tri_emp_4_clicked()
{
    ui->tab_depense->setModel(D.trier());
}
...
void gestion_revenue::on_pushButton_clicked()
{
    ui->stackedWidget->setCurrentIndex(1);
}

void gestion_revenue::on_pushButton_4_clicked()
{
...
void gestion_revenue::on_BA_2_clicked()
{
...
void gestion_revenue::on_b_supprimer_2_currentChanged(int index2)
{
...
void gestion_revenue::on_P_supprimer_2_clicked()
{
  revenue R1;
...
void gestion_revenue::on_comboBox_currentTextChanged_2(const QString &arg2)
{
...
void gestion_revenue::on_pushButton_6_clicked()
{
...
void gestion_revenue::on_linechercher1_3_cursorPositionChanged(int arg1, int arg2)
{
    revenue R;
        ui->tab_revenue->setModel(R.afficherecherche(ui->linechercher1_3->text()));

            QString test =ui->linechercher1_3->text();

            if(test=="")
            {
                ui->tab_revenue->setModel(R.afficher());//refresh
            }
}

void gestion_revenue::on_linechercher1_cursorPositionChanged(int arg1, int arg2)
{
    depense D;
        ui->tab_depense->setModel(D.afficherechercheD(ui->linechercher1->text()));

            QString test =ui->linechercher1->text();

            if(test=="")
            {
                ui->tab_depense->setModel(D.afficher());//refresh
            }
